...
- Documentation workflow
  ...
  - `cluster/overlays/homelab/platform/` overlays were removed as unused scaffolding; keep platform defaults in `cluster/base/*` and use issuer toggle docs instead of platform overlay path references.
  - `cluster/overlays/homelab/values/` was removed as unreferenced scaffolding; keep declarative values in component paths (`cluster/base/*`, provider/app overlays) instead of a shared homelab values directory.
