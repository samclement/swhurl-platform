...
readonly -A FEATURE_REQUIRED_VARS=(
  [cilium]="HUBBLE_HOST"
  [oauth2_proxy]="OAUTH_HOST OIDC_ISSUER OIDC_CLIENT_ID OIDC_CLIENT_SECRET OAUTH_COOKIE_SECRET"
  [clickstack]="CLICKSTACK_HOST CLICKSTACK_API_KEY CLICKSTACK_BOOTSTRAP_EMAIL CLICKSTACK_BOOTSTRAP_PASSWORD"
